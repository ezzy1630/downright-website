...
- curl: `curl -fsSL https://downright.cc/install | bash`
- npm: `npx --yes downright-installer`
- Homebrew tap: `brew tap ezzy1630/downright && brew trust --cask ezzy1630/downright/downright && brew install --cask downright`

# Downright press and product facts

Downright Markdown is a free, open-source native Markdown editor and viewer for macOS. It renders local Markdown exactly, reviews external agent rewrites live, and keeps the source file in charge.
...
- Platform: macOS 14+
- License: MIT
- Architecture: AppKit and TextKit 2; no WebView
- Integrations: Finder, Quick Look, Spotlight, Services, App Intents, and `down`
- Privacy: no account or telemetry required during ordinary use
...
- Start-window still: [/assets/downright-native-start-window.jpg](/assets/downright-native-start-window.jpg)
- Renderer showcase: [/assets/downright-renderer-showcase.png](/assets/downright-renderer-showcase.png)
- Press card: [/og/press.svg](/og/press.svg)
- External-write workflow card: [/og/guides-markdown-external-changes.svg](/og/guides-markdown-external-changes.svg)
- Live product surface: [downright.cc](/)
- Demo route: [review external changes](/guides/markdown-external-changes/)
